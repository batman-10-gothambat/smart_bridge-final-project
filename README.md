...
Built using FastAPI and Streamlit, the application ensures a responsive, interactive, and modular architecture. All components are unit-tested using pytest, with clearly defined backend services, routes, and a dynamic frontend. 
